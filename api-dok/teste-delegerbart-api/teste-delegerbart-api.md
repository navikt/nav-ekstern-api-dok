...
1. **Log into Selvbetjening for Maskinporten at DigDir:**
    ...
    - Check if you have access to the org you want to represent in the upper right corner. If you have chosen synthetic
      org, you can change it to the org you want to represent by clicking the org number in the top right corner.
